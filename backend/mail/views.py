...
from .serializers import LandlordMailSerializer, MailSerializer
...
class sendAuthMail(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response(
            {"message": "E-mail has been sent", "link": verification_link},
...
class verifyAuthToken(APIView):
    ...
    def post(self, request, *args, **kwargs):
        try:
            data = {
                "safe": request.query_params.get("safe"),
...
class LandlordContactMail(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({"message": "E-mail has been sent"}, status=status.HTTP_200_OK)
